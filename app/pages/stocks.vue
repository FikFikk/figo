    ...
    >
      <div class="max-w-2xl relative z-10">
        ...
        <div class="flex flex-wrap items-center gap-3">
          <NuxtLink to="/tradingplan"
            class="h-9 px-4 text-xs font-mono font-bold uppercase tracking-wider border rounded-lg transition-all flex items-center gap-2 cursor-pointer shadow-sm shrink-0"
            :class="isDark 
              ? 'bg-white text-neutral-950 border-white hover:bg-neutral-200' 
              : 'bg-neutral-950 text-white border-neutral-950 hover:bg-neutral-800'"
          >
            <span class="material-symbols-outlined text-sm leading-none">bolt</span>
            <span class="leading-none">Masuk ke Trading Plan Page</span>
            <span class="material-symbols-outlined text-sm leading-none">arrow_forward</span>
          </NuxtLink>

          <NuxtLink to="/tradingplan?symbol=BBCA"
            class="h-9 px-4 text-xs font-mono font-bold uppercase tracking-wider border rounded-lg transition-all opacity-80 hover:opacity-100 flex items-center gap-1.5 cursor-pointer shrink-0"
          ...
          >
            <span class="leading-none">Demo: BBCA Plan</span>
          </NuxtLink>
          ...
          <NuxtLink to="/tradingplan?symbol=FUTR"
            ...
            :class="isDark ? 'bg-neutral-900 border-neutral-700 text-neutral-300 hover:border-neutral-500' : 'bg-neutral-50 border-neutral-300 text-neutral-700 hover:bg-neutral-100'"
          >
            <span class="leading-none">Demo: FUTR Scalp</span>
          </NuxtLink>
        </div>
      </div>
    ...
    <div class="mb-12 space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="p-5 border rounded-xl space-y-2.5 transition-all"
          :class="isDark ? 'bg-[#0e1017] border-white/[0.08]' : 'bg-white border-neutral-200 shadow-xs'"
        >
          <div class="flex items-center justify-between">
            ...
            <span class="text-[9px] px-2 py-0.5 border rounded-md font-bold"
          ...
          <div class="text-[10px] p-2.5 border rounded-lg" :class="isDark ? 'bg-black/40 border-white/[0.06] text-neutral-400' : 'bg-neutral-50 border-neutral-200 text-neutral-600'">
        ...
        >
          ...
          <div class="text-[10px] p-2.5 border rounded-lg space-y-1" :class="isDark ? 'bg-black/40 border-white/[0.06] text-neutral-400' : 'bg-neutral-50 border-neutral-200 text-neutral-600'">
